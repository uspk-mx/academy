...
export const reviewsPageLabels: Record<"es" | "en", ReviewsPageLabels> = {
  es: defaultReviewsPageLabels,
  en: {
    pageTitle: "My Reviews",
    totalSuffixSingular: "review",
    totalSuffixPlural: "reviews",
    averageSuffix: "Average",
    statsTotal: "Total",
    statsAverage: "Average",
    statsFiveStars: "5 Stars",
    statsFourStars: "4 Stars",
    filterLabel: "Filter:",
    filterAll: "All",
    filterStars: "{n} ⭐",
    ...
    emptyDescription:
      "Share your thoughts on the courses you've taken to help other students!",
    emptyCta: "View my courses",
    noResultsTitle: "No reviews with that rating",
    noResultsDescription: "Try a different filter to see more reviews.",
    clearFilterCta: "View all",
    writeReviewCta: "Write review",
    editCta: "Edit",
    deleteCta: "Delete",
    createModalTitle: "New review",
    editModalTitle: "Edit review",
    deleteModalTitle: "Delete review",
    courseFieldLabel: "Course",
    coursePlaceholder: "Select a course",
    ratingFieldLabel: "Rating",
    commentFieldLabel: "Your review",
    commentPlaceholder: "Share your experience with this course…",
    charCounter: "{n}/{max}",
    starAria: "{n} stars",
    saveCta: "Save changes",
    savingCta: "Saving…",
    createCta: "Publish review",
    cancelCta: "Cancel",
    confirmDeleteCta: "Delete review",
    deleteConfirmation:
      "Are you sure you want to delete your review of '{course}'? This action cannot be undone.",
    allCoursesReviewed: "You've already reviewed all your courses.",
    errors: {
      required: "Fill in all fields.",
      ratingRange: "The rating must be between 1 and 5.",
      alreadyReviewed: "You already wrote a review for this course.",
      notFound: "We couldn't find that review.",
